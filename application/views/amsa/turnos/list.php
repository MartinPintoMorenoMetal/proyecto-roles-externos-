    ...
    <div class="col-xs-12 widget-container-col" id="widget-container-col-6">
        <div class="widget-box" id="widget-box-6">
            ...
            <div class="btn-group">
                ...
                <a class="btn btn-primary" href="<?php echo base_url();?>nuevo_turnos" >
                    Crear Nueva </a>
            </div>
                        ...
                        <table class="table table-striped table-hover" id="datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a  href="<?php echo base_url();?>editar_turnos/<?php echo $perfil_externo->id_turnos_sec?>" 
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a  href="<?php echo base_url();?>eliminar_turnos/<?php echo $perfil_externo->id_turnos_sec?>" 

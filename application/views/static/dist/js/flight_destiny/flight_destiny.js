var Flights_Destinys = {
    process_form : function(){
        
        let form = $('#form').serializeArray();
        let url = $('#form').attr('action');
        let message_error = Flights_Destinys.validate_form(form);
        console.log(form);
        ...
        $.ajax({
            ...
            success: function (response) {
                if(response.status == 200){
                    ...
                    window.location.href = window.location.origin + '/mi-escuela/configurarciones/destino_vuelo';
                    return false;
                }
